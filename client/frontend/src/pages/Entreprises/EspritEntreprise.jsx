...
import { Row, Col, Tab, ListGroup, Card } from 'react-bootstrap';
        ...
        <div className="container">
          <Row>
            ...
            <Col>
              ...
              <p>
                ...
                collaboration avec ses représentants, dans les domaines des TIC, du Génie Civil, de
                l’Electromécanique, de GRH et des langues (Français, Anglais, Allemand, Italien…).
              </p>
              <p>
                <strong>
                  Ces Formations proposées en inter ou en intra entreprise peuvent se présenter sous
                  les 3 formes :
                </strong>
              </p>
              <ul className="qualite-ul">
              ...
              <p>
                ...
                certifications sur les Logiciels des acteurs majeurs de L'informatique : Microsoft,
                Cisco, Oracle, LPL Apple, etc.
              </p>
            </Col>
          </Row>
          <Row className="margin-top-60">
            <Col>
              ...
              <ol>
                <li>
                  Ses experts en ingénierie de formation pour l'élaboration de parcours de formation
                  et ses 300 enseignants et formateurs pour la réalisation de ces parcours dans les
                  différents domaines technologiques et linguistiques.
                </li>
          ...
          <div className="margin-top-60">
                    ...
                    <Col sm={8}>
                      <Tab.Content>
                        <Tab.Pane eventKey="#link1">
                          <div>
                            <h4 style={{ color: '#ed1c24' }}>
                              Une démarche centrée sur l’analyse des besoins spécifiques de chaque
                              entreprise
                            </h4>
                            ...
                            <ul style={{ listStyle: 'disc', marginLeft: '20px' }}>
                              ...
                              <li>
                                Présenter l’offre d’Esprit en formation continue par secteur
                                d’activité.
                              </li>
                              <li>
                                Enquêter auprès des services concernés pour identifier leurs besoins
                                en compétences.
                              </li>
                              <li>
                                Analyser et consolider les besoins de l’entreprise en formation
                                continue.
                              </li>
                              <li>
                                Elaborer les cahiers des charges en collaboration avec l’entreprise.
                              </li>
                              <li>
                                Proposer un plan d’action et le faire valider par l’entreprise.
                              </li>
                        ...
                        <Tab.Pane eventKey="#link2">
                          <div>
                            <h4 style={{ color: '#ed1c24' }}>
                              Un Niveau de Formation adapté à l’analyse des besoins
                            </h4>
                            <hr style={{ color: '#ed1c24', borderTop: '2px solid' }}></hr>
                        ...
                        <Tab.Pane eventKey="#link3">
                          <div>
                            <h4 style={{ color: '#ed1c24' }}>
                              Population cible et Niveau de qualification
                            </h4>
                            <hr style={{ color: '#ed1c24', borderTop: '2px solid' }}></hr>
            ...
            <Row className="margin-top-60">
              <p>
                Assurer l’évaluation et la certification des compétences techniques en collaboration
                avec les organismes Compétents pour :
              </p>
              <ul style={{ listStyle: 'disc', marginLeft: '20px' }}>
              ...
              <Col>
                <div>
                  ...
                  <ul style={{ listStyle: 'disc', marginLeft: '20px' }}>
                    ...
                    <li>Cloud et vertualisation</li>
                    <li>Intieropérabilité</li>
              ...
              <Col>
                <div>
                  ...
                  <ul style={{ listStyle: 'disc', marginLeft: '20px' }}>
                    ...
                    <li>
                      Travaux de Bâtiment (Menuiserie, Maçonnerie, Marbrerie, Plomberie sanitaire).
                    </li>
                  </ul>
                </div>
              </Col>
                ...
                <div>
                  <div className="circle-headline">
                    ...
                    <h4 className="circle-title">
                      Mécanique, Electromécanique, Maintenance industrielle et Thermique
                    </h4>
                  </div>
                  <ul style={{ listStyle: 'disc', marginLeft: '20px' }}>
                    <li>Techologies des systèmes mécaniques</li>
              ...
              <Col>
                <div>
                  <div className="circle-headline">
                    ...
                    <h4 className="circle-title">
                      Soudure, construction métallique, chaudronnerie
                    </h4>
                  </div>
                  <ul style={{ listStyle: 'disc', marginLeft: '20px' }}>
