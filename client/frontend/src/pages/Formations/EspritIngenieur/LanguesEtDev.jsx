...
import VieEcole from '../../../components/VieEcole';
import breadcrumbbg from '../../../assets/img/selfdeveloppement.jpg';
import Icofont from 'react-icofont';
import { Row, Col } from 'react-bootstrap';
import etudiants from '../../../assets/img/etudiants-esprit.jpg';
class LanguesEtDev extends Component {
  render() {
            ...
            <div className="margin-top-60">
              <Row style={{ marginBottom: '60px' }}>
                <Col>
                  <p>
                    <strong>
                      La politique linguistique UP Langues s’articule autour de 3 axes fondamentaux
                    </strong>
                  </p>
              ...
              <Row style={{ marginBottom: '60px' }}>
                <Row>
                  ...
                  <Col>
                    <p>
                      Soucieuse de former une génération de futurs ingénieurs citoyens compétents
                      dans leur spécialité et bons communicants, l’UP met en place des programmes
                      qui, tout en s’appuyant sur les objectifs déclinés dans les descripteurs du
                      CECR (Cadre européen commun de référence pour les langues) sont conformes aux
                      exigences de la CTI. Ils s’inscrivent ainsi dans une approche qui prône la
                      communication, la culture et la citoyenneté tout en veillant à la richesse du
                      contenu (thématiques, supports, activités).
                    </p>
                    <p>
                      En effet, les documents sont exploités selon 3 volets : linguistique,
                      fonctionnel et culturel. Le volet linguistique est traité à travers des mises
                      en situation et des simulations dont les acquis sont vérifiés dans le cadre de
                      projets intégrés, tests et ateliers de création.
                    </p>
                  </Col>
                </Row>
                <Row>
<p>Grâce à l’APP, l’apprenant se trouve dans un contexte où l’apprentissage des langues ne se fait plus de manière classique et purement utilitariste, il est au contraire au centre de sa formation et y participe activement conformément au slogan de l’école <strong>SE FORMER AUTREMENT.</strong> En fin de cursus, l’apprenant est initié à la vie professionnelle avec un module dédié entièrement à cet effet : dossier de candidature (CV, lettre de motivation et entretien d’embauche), compétences personnelles et culture d’entreprise  seront alors  les principaux axes de cette dernière ligne droite.</p>
                <p>
