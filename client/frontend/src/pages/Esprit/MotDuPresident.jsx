          ...
          <div className="container">
            <div>
              ...
              <Row>
                <Col>
                  <h6 className="quote">
                    "Bienvenue sur le site d’Esprit où vous trouverez, je l’espère, l’ensemble des
                    informations que vous êtes venus y chercher."
                  </h6>
                </Col>
              </Row>
            </div>
            <div className="margin-top-60">
              <Row>
                ...
                <Col>
                  <p>
                    Cela fait maintenant 13 ans qu’à Esprit nous avons le plaisir de voir des
                    étudiants venir s’épanouir et finalement aboutir à prendre en main leur avenir
                    professionnel.
                    <br></br>
                    13 ans que nous nous engageons au quotidien pour assurer la meilleure formation
                    possible, celle qui correspond le mieux à notre tissu socio-économique, celle
                    qui donne un emploi à nos étudiants. C’est ainsi que de 30 étudiants lors de la
                    première promotion nous en sommes à près de 5000 étudiants dans nos 4 filières
                    (Informatique, télécommunications, génie électromécanique et génie civil).
                  </p>
                </Col>
                <Col>
                  <p>
                    Sans compter nos 107 étudiants en classes préparatoires aux Grandes Ecoles
                    d’Ingénieur et bientôt ceux que nous accueilleront dans le cadre de notre
                    nouvelle école de Management.<br></br>
                    Esprit est aujourd’hui la première école d’ingénieur de Tunisie, elle forme plus
                    de 15% des nouveaux ingénieurs diplômés du pays chaque année, et ceux-ci
                    s’intègrent avec bonheur dans le marché de l’emploi.
                  </p>
                </Col>
              </Row>
            </div>
