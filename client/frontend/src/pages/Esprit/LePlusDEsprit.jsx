              ...
              <Row style={{ marginBottom: '60px' }}>
                  ...
                  <div className="services-box">
                    <div className="services-box-icon">
                      <div className="services-box-icon-inner">
                        <Icofont className="services-box-fonticon" icon={'icofont-hat-alt'} />
                      ...
                      <ul className="services-box-list">
                        <li className="">
                          <span className="services-box-list-text">
                            Créativité et compétences opérationnelles,
                          </span>
                        </li>
                        <li className="">
                          <span className="services-box-list-text">
                            Qualités humaines : esprit d’équipe, communication, leadership,
                            créativité, rigueur,
                          </span>
                        </li>
                        <li className="">
                        ...
                        <li className="">
                          <span className="services-box-list-text">
                            Reconnaissance internationale à travers l’accréditation EUR- ACE
                            (délivrée par la CTI) Et par l’adhésion à la conférence des grandes
                            école (CGE) et l’initiative CDIO + les 3 logos.
                          </span>
                        </li>
                      </ul>
                    </div>
                ...
                <Col>
                  <div className="services-box">
                    <div className="services-box-icon">
                      <div className="services-box-icon-inner">
                        <Icofont className="services-box-fonticon" icon={'icofont-book-alt'} />
                      </div>
                    </div>
                    <div className="services-box-content">
                      ...
                      <div className="services-box-desc">
                        <p>
                          Des synergies fortes entre les différentes formations (ingénieur,
                          management, classes préparatoires) :
                        </p>
                      </div>
                      ...
                      <ul className="services-box-list">
                        <li className="">
                          <span className="services-box-list-text">
                            Une équipe pédagogique de 250 enseignants permanents qualifiés (1 pour
                            18 étudiants),
                          </span>
                        </li>
                        <li className="">
                          <span className="services-box-list-text">
                            L’accompagnement personnalisé des étudiants, en particulier les
                            étudiants étrangers qui bénéficient d’un service spécial pour suivre
                            leur dossier,
                          </span>
                        </li>
                        <li className="">
                          <span className="services-box-list-text">
                            L’enseignement en petits groupes de 30,
                          </span>
                        </li>
                        <li className="">
                          <span className="services-box-list-text">
              ...
              <Row>
                <Col>
                  <div className="services-box">
                    <div className="services-box-icon">
                      <div className="services-box-icon-inner">
                        <Icofont className="services-box-fonticon" icon={'icofont-briefcase-2'} />
                      </div>
                    </div>
                    <div className="services-box-content">
                      ...
                      <div className="services-box-desc">
                        <p>
                          Une vie étudiante riche et variée qui complète pleinement la formation
                          académique :
                        </p>
                      </div>
                      ...
                      <ul className="services-box-list">
                        <li className="">
                          <span className="services-box-list-text">
                            Plus de 40 clubs dans des domaines très divers (Junior entreprise,
                            Enactus, club santé, club théâtre, club google ou Mozilla ...),{' '}
                          </span>
                        </li>
                        <li className="">
                          <span className="services-box-list-text">
                            Possibilité de participer à des compétitions sportive de haut niveau :
                            les étudiants d’Esprit se retrouvent régulièrement en finale des
                ...
                <Col>
                  <div>
                    ...
                    <p>
                      Etudiants qui trouvent un travail dans les 6 mois qui suivent l’obtention du
                      diplôme
                    </p>
              ...
              <Row>
                <Col>
                  <div className="services-box">
                    <div className="services-box-icon">
                      <div className="services-box-icon-inner">
                        <Icofont className="services-box-fonticon" icon={'icofont-rocket'} />
                    ...
                    <div className="services-box-content">
                      ...
                      <div className="services-box-desc">
                        <p>
                          89% des élèves d’Esprit Prépa intègrent une grande école française ou
                          tunisienne en 2015 :
                        </p>
                      </div>
                      ...
                      <ul className="services-box-list">
                        <li className="">
                          <span className="services-box-list-text">
                            1 au concours des écoles normales supérieures
                          </span>
                        </li>
                        <li className="">
                          <span className="services-box-list-text">
                            1 à l’école polytechnique (X)
                          </span>
                        </li>
                        <li className="">
                          <span className="services-box-list-text">
